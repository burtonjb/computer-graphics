...
lib.write_pam("../images/alpha_i_1.pam", i_1)
lib.write_pam("../images/alpha_i_2.pam", i_2) 

out_1 = lib.alpha_blend(i_1, i_2)
out_2 = lib.alpha_blend(i_2, i_1)

lib.write_pam("../images/alpha_blend_out_1.pam", out_1)
lib.write_pam("../images/alpha_blend_out_2.pam", out_2) 
