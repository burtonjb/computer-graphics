...
lib.write_pam('../images/04_affine_start.pam', image)
...
lib.write_pam("../images/04_affine_identity_transform.pam", x)
...
lib.write_pam("../images/04_affine_translation.pam", x)
...
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_reflection.pam", x)
...
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_90_degree_reflection.pam", x)
...
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_45_degree_reflection.pam", x)
...
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_scale_y_.5.pam", x)
...
m = utils.to_matrix_d(scale)
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_scale_1.5x_and_y.pam", x)
...
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_shear_x.pam", x)
...
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_shear_y.pam", x)

-- shear x and y
m = utils.to_matrix_d(utils.matrix_multiply(shear_x, shear_y))
x = lib.affine_transform(image, m)
lib.write_pam("../images/04_affine_shear_x_and_y.pam", x)