...
lib.write_pam('../images/05_kernel_transform_initial.pam', image)
...
lib.write_pam("../images/05_kernel_transform_identity.pam", x)
...
lib.write_pam("../images/05_kernel_transform_blur.pam", x)
...
x = lib.kernel_transform(image, utils.to_matrix_d(blur))
lib.write_pam("../images/05_kernel_transform_blur_no_normalization.pam", x)
...
lib.write_pam("../images/05_kernel_transform_gaussian_blur.pam", x)
...
lib.write_pam("../images/05_kernel_transform_sharpen.pam", x)
...
lib.write_pam("../images/05_kernel_transform_edge_detection.pam", x)